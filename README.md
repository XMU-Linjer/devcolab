...
- 文档树：创建根文档和子文档、查看工作区文档树、打开文档、重命名、移动层级、删除文档。
...
1. 搜索模块：文档和 Block 的基础检索。
2. 协作模块：WebSocket 房间、心跳、在线状态。
3. Git 归档：文档版本和代码仓库关联。
4. Agent Review：规则评审、证据链、RAG 上下文。
5. 生产化补齐：部署脚本、监控指标、审计日志和更完整的权限策略。
