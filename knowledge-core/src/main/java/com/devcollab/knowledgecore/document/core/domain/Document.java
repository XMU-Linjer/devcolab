...
// 生命周期通过 reviewStatus 流转：DRAFT → IN_REVIEW → PUBLISHED/REJECTED → DEPRECATED → SUPERSEDED
public record Document(
        ...
        DocumentReviewStatus reviewStatus,  // 评审状态：DRAFT / IN_REVIEW / PUBLISHED / REJECTED / DEPRECATED / SUPERSEDED
