...
| 92 | `92-local-frontend-technology-adr-v0.7.md` | 工作区规范路由、应用外壳、首帧闪现排错与真实浏览器验收 | V0.7 | 已由 `.gitignore` 精确忽略 |
...
| 92 | `92-local-frontend-technology-adr-v0.7.md` | 工作区规范路由、Route Meta 外壳契约、历史语义与排错复盘 | V0.7 | 已由 `.gitignore` 精确忽略 |
