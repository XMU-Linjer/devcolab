...
| 92 | `92-local-frontend-technology-adr-v0.8.md` | 仓库树目录优先自然排序、稳定节点状态与低动画交互验收 | V0.8 | 已由 `.gitignore` 精确忽略 |
...
| 92 | `92-local-frontend-technology-adr-v0.8.md` | 仓库树数据适配、Intl.Collator、稳定 key 与 Element Plus Tree 排错 | V0.8 | 已由 `.gitignore` 精确忽略 |
